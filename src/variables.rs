            ...
            &MulExpr(ref ref_left_expr, ref ref_right_expr) => {
                ...
                match (left_expr, right_expr) {
                    ...
                    (i, &AddExpr(ref a, ref b)) => simplify(&AddExpr(
                        Rc::new(MulExpr(Rc::new(i.clone()), a.clone())),
                        Rc::new(MulExpr(Rc::new(i.clone()), b.clone())),
                    )),
                    // (a+b)*i = i*a+i*b
                    ...
                    (&LitVal(c1), &MulExpr(ref ref_c2, ref expr)) => {
                        ...
                        if let &LitVal(c2) = cc2 {
                            ...
                            MulExpr(
                                Rc::new(MulExpr(Rc::new(LitVal(c1)), Rc::new(cc2.clone()))),
                                expr.clone(),
                            )
                        }
                    }
                    ...
                    (expr, &MulExpr(ref ref_left_mul, ref ref_right_mul)) => simplify(&MulExpr(
                        Rc::new(MulExpr(Rc::new(expr.clone()), ref_left_mul.clone())),
                        ref_right_mul.clone(),
                    )),
                    ...
                    (_, _) => MulExpr(Rc::new(simplify(left_expr)), Rc::new(simplify(right_expr))),
                }
            }
            &AddExpr(ref ref_left_expr, ref ref_right_expr) => {
                ...
                match (left_expr, right_expr) {
                    ...
                    (a, &AddExpr(ref b, ref c)) => simplify(&AddExpr(
                        Rc::new(AddExpr(Rc::new(a.clone()), b.clone())),
                        c.clone(),
                    )),
                    ...
                    (&AddExpr(ref expr, ref rc1), &LitVal(c2)) => match **rc1 {
                        ...
                        _ => AddExpr(
                            Rc::new(simplify(ref_left_expr)),
                            Rc::new(simplify(ref_right_expr)),
                        ),
                    },
                    ...
                    (&SubExpr(ref rc1, ref rc2), &LitVal(c2)) => {
                        ...
                        match (cc1, cc2) {
                            (_, &LitVal(c1)) => {
                                simplify(&AddExpr(rc1.clone(), Rc::new(LitVal(c1 - c2))))
                            }
                            (&LitVal(c1), _) => simplify(&AddExpr(
                                Rc::new(SubExpr(Rc::new(LitVal(0.0)), rc2.clone())),
                                Rc::new(LitVal(c1 + c2)),
                            )),
                            _ => AddExpr(
                                Rc::new(simplify(ref_left_expr)),
                    ...
                    (&AddExpr(ref expr1, ref rc), expr2) => match **rc {
                        LitVal(c1) => simplify(&AddExpr(
                            Rc::new(AddExpr(expr1.clone(), Rc::new(expr2.clone()))),
                            Rc::new(LitVal(c1)),
                        )),
                        _ => AddExpr(
                            Rc::new(simplify(ref_left_expr)),
            ...
            &SubExpr(ref ref_left_expr, ref ref_right_expr) => {
                ...
                match (left_expr, right_expr) {
                    ...
                    (a, &AddExpr(ref b, ref c)) => simplify(&SubExpr(
                        Rc::new(SubExpr(Rc::new(a.clone()), b.clone())),
                        c.clone(),
                    )),
                    ...
                    // Place literal at the end
                    (&LitVal(c), expr) => simplify(&AddExpr(Rc::new(-expr), Rc::new(LitVal(c)))),
                    ...
                    (&SubExpr(ref rc1, ref rc2), &LitVal(c2)) => {
                        ...
                        match (cc1, cc2) {
                            (_, &LitVal(c1)) => {
                                simplify(&SubExpr(rc1.clone(), Rc::new(LitVal(c1 + c2))))
                            }
                            (&LitVal(c1), _) => simplify(&AddExpr(
                                Rc::new(SubExpr(Rc::new(LitVal(0.0)), rc2.clone())),
                                Rc::new(LitVal(c1 - c2)),
                    ...
                    (&AddExpr(ref expr1, ref rc), expr2) => match **rc {
                        LitVal(c) => simplify(&AddExpr(
                            Rc::new(SubExpr(expr1.clone(), Rc::new(expr2.clone()))),
                            Rc::new(LitVal(c)),
                        )),
                        _ => SubExpr(
                            Rc::new(simplify(ref_left_expr)),
